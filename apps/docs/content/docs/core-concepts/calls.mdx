...
<Callout title="Note">
  ...
  Read more in [Using Callsheet with React Query](/guides/react-query#applying-shared-invalidation) and
  [Call Family and Identity](/core-concepts/call-family-and-identity#call-family-invalidation).
</Callout>
