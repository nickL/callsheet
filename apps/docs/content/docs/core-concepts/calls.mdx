...
<Callout title="Note">
  ...
  Query](/guides/react-query#applying-shared-invalidation), [Using Callsheet
  with SWR](/guides/swr#applying-shared-invalidation), and [Call Family and
  Identity](/core-concepts/call-family-and-identity#call-family-invalidation).
</Callout>

## Components still use your adapter [!toc]
...
Calls do not replace how you compose with your data-fetching library. They give it a cleaner model to build from.
